...
class Owner(object):
    ...
    def __init__(self, kind=None, name=None, id=None):  # noqa: E501
    ...
    @property
    def kind(self):
        """Gets the kind of this Owner.  # noqa: E501


        :return: The kind of this Owner.  # noqa: E501
        :rtype: str
        """
        return self._kind
    ...
    @kind.setter
    def kind(self, kind):
        """Sets the kind of this Owner.


        :param kind: The kind of this Owner.  # noqa: E501
        :type: str
        """
        if kind is None:
