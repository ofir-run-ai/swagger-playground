...
class AdvancedFlatFields(object):
    ...
    def __init__(self, terminate_after_preemption=None, auto_deletion_time_after_completion_seconds=None, backoff_limit=None):  # noqa: E501
        """AdvancedFlatFields - a model defined in Swagger"""  # noqa: E501
    ...
    def terminate_after_preemption(self):
        """Gets the terminate_after_preemption of this AdvancedFlatFields.  # noqa: E501

        Indicates if the job should be terminated by the system after it has been preempted.  # noqa: E501

        :return: The terminate_after_preemption of this AdvancedFlatFields.  # noqa: E501
        :rtype: bool
        """
    ...
    def terminate_after_preemption(self, terminate_after_preemption):
        """Sets the terminate_after_preemption of this AdvancedFlatFields.

        Indicates if the job should be terminated by the system after it has been preempted.  # noqa: E501

        :param terminate_after_preemption: The terminate_after_preemption of this AdvancedFlatFields.  # noqa: E501
        :type: bool
        """
    ...
    def auto_deletion_time_after_completion_seconds(self):
        """Gets the auto_deletion_time_after_completion_seconds of this AdvancedFlatFields.  # noqa: E501
        ...
        :return: The auto_deletion_time_after_completion_seconds of this AdvancedFlatFields.  # noqa: E501
        :rtype: int
        """
    ...
    def auto_deletion_time_after_completion_seconds(self, auto_deletion_time_after_completion_seconds):
        """Sets the auto_deletion_time_after_completion_seconds of this AdvancedFlatFields.

        Specifies the duration after which a finished workload (completed or failed) will be automatically deleted. The default is 30 days.  # noqa: E501

        :param auto_deletion_time_after_completion_seconds: The auto_deletion_time_after_completion_seconds of this AdvancedFlatFields.  # noqa: E501
        :type: int
        """
    ...
    def backoff_limit(self):
        """Gets the backoff_limit of this AdvancedFlatFields.  # noqa: E501
        ...
        :return: The backoff_limit of this AdvancedFlatFields.  # noqa: E501
        :rtype: int
        """
    ...
    def backoff_limit(self, backoff_limit):
        """Sets the backoff_limit of this AdvancedFlatFields.

        Specifies the number of retries before marking a workload as failed (not applicable to Inference workloads). The default value is 6.  # noqa: E501

        :param backoff_limit: The backoff_limit of this AdvancedFlatFields.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdvancedFlatFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdvancedFlatFields):
            return False
