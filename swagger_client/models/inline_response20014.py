...
class InlineResponse20014(object):
    ...
    swagger_types = {
        'next': 'int',
        'datavolumes': 'DatavolumesNoSharedScopes'
    }
    ...
    def __init__(self, next=None, datavolumes=None):  # noqa: E501
    ...
    def datavolumes(self):
        """Gets the datavolumes of this InlineResponse20014.  # noqa: E501


        :return: The datavolumes of this InlineResponse20014.  # noqa: E501
        :rtype: DatavolumesNoSharedScopes
        """
        return self._datavolumes

    @datavolumes.setter
    def datavolumes(self, datavolumes):
        """Sets the datavolumes of this InlineResponse20014.


        :param datavolumes: The datavolumes of this InlineResponse20014.  # noqa: E501
        :type: DatavolumesNoSharedScopes
        """
        if datavolumes is None:
            raise ValueError("Invalid value for `datavolumes`, must not be `None`")  # noqa: E501
