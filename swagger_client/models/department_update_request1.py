...
class DepartmentUpdateRequest1(object):
    ...
    def __init__(self, node_pools_resources=None, name=None, deserved_gpus=None, allow_over_quota=None, max_allowed_gpus=None, resources=None):  # noqa: E501
        """DepartmentUpdateRequest1 - a model defined in Swagger"""  # noqa: E501
    ...
    def node_pools_resources(self):
        """Gets the node_pools_resources of this DepartmentUpdateRequest1.  # noqa: E501

        Resources assigned to this Department per Node Pool  # noqa: E501

        :return: The node_pools_resources of this DepartmentUpdateRequest1.  # noqa: E501
    ...
    def node_pools_resources(self, node_pools_resources):
        """Sets the node_pools_resources of this DepartmentUpdateRequest1.

        Resources assigned to this Department per Node Pool  # noqa: E501

        :param node_pools_resources: The node_pools_resources of this DepartmentUpdateRequest1.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DepartmentUpdateRequest1.  # noqa: E501

        The name of the department.  # noqa: E501

        :return: The name of this DepartmentUpdateRequest1.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DepartmentUpdateRequest1.

        The name of the department.  # noqa: E501

        :param name: The name of this DepartmentUpdateRequest1.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def deserved_gpus(self):
        """Gets the deserved_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        ...
        :return: The deserved_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        :rtype: float
        """
    ...
    def deserved_gpus(self, deserved_gpus):
        """Sets the deserved_gpus of this DepartmentUpdateRequest1.

        Deprecated. Instead, use `deserved` for the relevant resource type under `NodePoolResources`. Deserved GPUs for the department.  # noqa: E501

        :param deserved_gpus: The deserved_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        :type: float
        """
    ...
    def allow_over_quota(self):
        """Gets the allow_over_quota of this DepartmentUpdateRequest1.  # noqa: E501
        ...
        :return: The allow_over_quota of this DepartmentUpdateRequest1.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_over_quota(self, allow_over_quota):
        """Sets the allow_over_quota of this DepartmentUpdateRequest1.

        Deprecated. Instead, use `maxAllowed` for the relevant resource type under `NodePoolResources`. Is over quota allowed for the department.  # noqa: E501

        :param allow_over_quota: The allow_over_quota of this DepartmentUpdateRequest1.  # noqa: E501
        :type: bool
        """
    ...
    def max_allowed_gpus(self):
        """Gets the max_allowed_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        ...
        :return: The max_allowed_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        :rtype: float
        """
    ...
    def max_allowed_gpus(self, max_allowed_gpus):
        """Sets the max_allowed_gpus of this DepartmentUpdateRequest1.

        Deprecated. Instead, use `maxAllowed` for the relevant resource type under `NodePoolResources`. Max allowed GPUs for the department.  # noqa: E501

        :param max_allowed_gpus: The max_allowed_gpus of this DepartmentUpdateRequest1.  # noqa: E501
        :type: float
        """
    ...
    @property
    def resources(self):
        """Gets the resources of this DepartmentUpdateRequest1.  # noqa: E501
        ...
        :return: The resources of this DepartmentUpdateRequest1.  # noqa: E501
        :rtype: object
        """
    ...
    def resources(self, resources):
        """Sets the resources of this DepartmentUpdateRequest1.

        Deprecated. Instead, use 'nodePoolsResources'. Total resources assigned to the Department. Can only be used in PUT/POST when there is a single Node Pool in the system. The resources returned in GET are the sum of all Node Pool Resources.  # noqa: E501

        :param resources: The resources of this DepartmentUpdateRequest1.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DepartmentUpdateRequest1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DepartmentUpdateRequest1):
            return False
