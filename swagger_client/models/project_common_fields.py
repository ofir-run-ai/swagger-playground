...
class ProjectCommonFields(object):
    ...
    swagger_types = {
        ...
        'node_affinity': 'AllOfProjectCommonFieldsNodeAffinity',
        'permissions': 'AllOfProjectCommonFieldsPermissions',
        'resources': 'AllOfProjectCommonFieldsResources'
    }
    ...
    def deserved_gpus(self):
        """Gets the deserved_gpus of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The deserved_gpus of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def deserved_gpus(self, deserved_gpus):
        """Sets the deserved_gpus of this ProjectCommonFields.

        Deprecated. Use 'deserved' for the relevant resource type under `NodePoolResources`. The project's deserved GPU allocation in case the cluster has those resources.  # noqa: E501

        :param deserved_gpus: The deserved_gpus of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def max_allowed_gpus(self):
        """Gets the max_allowed_gpus of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The max_allowed_gpus of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def max_allowed_gpus(self, max_allowed_gpus):
        """Sets the max_allowed_gpus of this ProjectCommonFields.

        Deprecated. Instead, use `maxAllowed` for the relevant resource type under `NodePoolResources`. An upper limit for the amount of GPUs the project can get (Even if over quota is allowed and resources are available).  # noqa: E501

        :param max_allowed_gpus: The max_allowed_gpus of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def gpu_over_quota_weight(self):
        """Gets the gpu_over_quota_weight of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The gpu_over_quota_weight of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def gpu_over_quota_weight(self, gpu_over_quota_weight):
        """Sets the gpu_over_quota_weight of this ProjectCommonFields.

        Deprecated. Instead, use `overQuotaWeight` for the relevant resource type under `NodePoolResources`. The priority the project gets for over quota resources.  # noqa: E501

        :param gpu_over_quota_weight: The gpu_over_quota_weight of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def default_node_pools(self):
        """Gets the default_node_pools of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The default_node_pools of this ProjectCommonFields.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def default_node_pools(self, default_node_pools):
        """Sets the default_node_pools of this ProjectCommonFields.

        Default node pools list for workload submission for this project if a workload doesn't specify a node pools list.  # noqa: E501

        :param default_node_pools: The default_node_pools of this ProjectCommonFields.  # noqa: E501
        :type: list[str]
        """
    ...
    def interactive_job_time_limit_secs(self):
        """Gets the interactive_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501

        A limit (in seconds) for the duration of interactive jobs from this project.  # noqa: E501

        :return: The interactive_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def interactive_job_time_limit_secs(self, interactive_job_time_limit_secs):
        """Sets the interactive_job_time_limit_secs of this ProjectCommonFields.

        A limit (in seconds) for the duration of interactive jobs from this project.  # noqa: E501

        :param interactive_job_time_limit_secs: The interactive_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def interactive_job_max_idle_duration_secs(self):
        """Gets the interactive_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501

        Maximum duration (in seconds) that an interactive job can be idle before being terminated.  # noqa: E501

        :return: The interactive_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def interactive_job_max_idle_duration_secs(self, interactive_job_max_idle_duration_secs):
        """Sets the interactive_job_max_idle_duration_secs of this ProjectCommonFields.

        Maximum duration (in seconds) that an interactive job can be idle before being terminated.  # noqa: E501

        :param interactive_job_max_idle_duration_secs: The interactive_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def interactive_preemptible_job_max_idle_duration_secs(self):
        """Gets the interactive_preemptible_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501

        Maximum duration (in seconds) that an interactive preemptible job can be idle before being terminated.  # noqa: E501

        :return: The interactive_preemptible_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def interactive_preemptible_job_max_idle_duration_secs(self, interactive_preemptible_job_max_idle_duration_secs):
        """Sets the interactive_preemptible_job_max_idle_duration_secs of this ProjectCommonFields.

        Maximum duration (in seconds) that an interactive preemptible job can be idle before being terminated.  # noqa: E501

        :param interactive_preemptible_job_max_idle_duration_secs: The interactive_preemptible_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def training_job_time_limit_secs(self):
        """Gets the training_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The training_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def training_job_time_limit_secs(self, training_job_time_limit_secs):
        """Sets the training_job_time_limit_secs of this ProjectCommonFields.

        A limit (in seconds) for the duration of training jobs from this project. Available only from cluster version 2.12  # noqa: E501

        :param training_job_time_limit_secs: The training_job_time_limit_secs of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def training_job_max_idle_duration_secs(self):
        """Gets the training_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501

        Maximum duration (in seconds) that a training job can be idle before being terminated.  # noqa: E501

        :return: The training_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :rtype: float
        """
    ...
    def training_job_max_idle_duration_secs(self, training_job_max_idle_duration_secs):
        """Sets the training_job_max_idle_duration_secs of this ProjectCommonFields.

        Maximum duration (in seconds) that a training job can be idle before being terminated.  # noqa: E501

        :param training_job_max_idle_duration_secs: The training_job_max_idle_duration_secs of this ProjectCommonFields.  # noqa: E501
        :type: float
        """
    ...
    def node_affinity(self):
        """Gets the node_affinity of this ProjectCommonFields.  # noqa: E501

        Node affinity configuration for jobs in the project.  # noqa: E501

        :return: The node_affinity of this ProjectCommonFields.  # noqa: E501
        :rtype: AllOfProjectCommonFieldsNodeAffinity
        """
        return self._node_affinity

    @node_affinity.setter
    def node_affinity(self, node_affinity):
        """Sets the node_affinity of this ProjectCommonFields.

        Node affinity configuration for jobs in the project.  # noqa: E501

        :param node_affinity: The node_affinity of this ProjectCommonFields.  # noqa: E501
        :type: AllOfProjectCommonFieldsNodeAffinity
        """
    ...
    def permissions(self):
        """Gets the permissions of this ProjectCommonFields.  # noqa: E501

        Deprecated. Instead, use the `accessRules` API to add permissions to a specific subject in the project scope.  # noqa: E501

        :return: The permissions of this ProjectCommonFields.  # noqa: E501
        :rtype: AllOfProjectCommonFieldsPermissions
        """
        return self._permissions

    @permissions.setter
    def permissions(self, permissions):
        """Sets the permissions of this ProjectCommonFields.

        Deprecated. Instead, use the `accessRules` API to add permissions to a specific subject in the project scope.  # noqa: E501

        :param permissions: The permissions of this ProjectCommonFields.  # noqa: E501
        :type: AllOfProjectCommonFieldsPermissions
        """
    ...
    @property
    def resources(self):
        """Gets the resources of this ProjectCommonFields.  # noqa: E501
        ...
        :return: The resources of this ProjectCommonFields.  # noqa: E501
        :rtype: AllOfProjectCommonFieldsResources
        """
        return self._resources

    @resources.setter
    def resources(self, resources):
        """Sets the resources of this ProjectCommonFields.

        Deprecated. Instead, use `nodePoolsResources`. Total resources assigned to the Project. Can only be used in PUT/POST when there is a single Node Pool in the system. The resources returned in `GET` are the sum of all Node Pool Resources.  # noqa: E501

        :param resources: The resources of this ProjectCommonFields.  # noqa: E501
        :type: AllOfProjectCommonFieldsResources
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectCommonFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectCommonFields):
            return False
