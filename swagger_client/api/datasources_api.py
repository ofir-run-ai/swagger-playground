...
class DatasourcesApi(object):
    ...
    def list_datasource_assets(self, **kwargs):  # noqa: E501
        """List datasource assets.  # noqa: E501

        Returns a combined list of data-sources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_datasource_assets(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_datasource_assets_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_datasource_assets_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_datasource_assets_with_http_info(self, **kwargs):  # noqa: E501
        """List datasource assets.  # noqa: E501

        Returns a combined list of data-sources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_datasource_assets_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_datasource_assets" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='DatasourceListResponse',  # noqa: E501
